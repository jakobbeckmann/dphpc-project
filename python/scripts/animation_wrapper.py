...
from python.libs.postprocessing.AnimDataLoader import AnimDataLoader
from python.libs.postprocessing.ChanAnimation import ChanAnimation
...
data_dir        = 'test_1128_12739/sub_0'
